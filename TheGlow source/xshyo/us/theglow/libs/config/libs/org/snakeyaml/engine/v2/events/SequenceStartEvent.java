...
public final class SequenceStartEvent extends CollectionStartEvent {
   public SequenceStartEvent(Optional<Anchor> var1, Optional<String> var2, boolean var3, FlowStyle var4, Optional<Mark> var5, Optional<Mark> var6) {
      super(var1, var2, var3, var4, var5, var6);
   }

   public SequenceStartEvent(Optional<Anchor> var1, Optional<String> var2, boolean var3, FlowStyle var4) {
   ...
   public String toString() {
      StringBuilder var1 = new StringBuilder("+SEQ");
